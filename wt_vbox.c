 ...
 *
 *  wt_vbox.c: Widget type 'vbox'
 */

#include "stfl.h"

static void wt_vbox_getminwh(struct stfl_widget *w)
{
	w->min_w = 0;
	w->min_h = 0;
...
static void wt_vbox_draw(struct stfl_widget *w, WINDOW *win)
{
	...
	int sizes_extra = w->h - sizes_total;
	int current_y = w->y;
